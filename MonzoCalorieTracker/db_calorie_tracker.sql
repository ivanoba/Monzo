...
--
-- Host: localhost    Database: db_calorie_tracker
-- ------------------------------------------------------
...
CREATE TABLE `calorietracker` (
  ...
  `nickPersona` varchar(50) NOT NULL,
  PRIMARY KEY (`codigo`),
  KEY `nickPersona` (`nickPersona`),
  CONSTRAINT `calorietracker_ibfk_1` FOREIGN KEY (`nickPersona`) REFERENCES `persona` (`nick`)
...
CREATE TABLE `comida` (
  ...
  CONSTRAINT `comida_ibfk_1` FOREIGN KEY (`codigoTracker`) REFERENCES `calorietracker` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-02 19:40:08
